...
maxlength = int(
    input('please enter the length you will need for your password\n'))
...
All_chars = random.choice(Figures) + random.choice(Lower_case) + \
    random.choice(Upper_case) + random.choice(Special_chars)
